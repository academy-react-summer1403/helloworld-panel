  ...
  return defineConfig({
    ...
    resolve: {
      alias: [
        ...
        { find: '@layouts', replacement: path.resolve(__dirname, 'src/components/common/layouts') },
        ...
        { find: '@coreComponents', replacement: path.resolve(__dirname, 'src/components/common') },
