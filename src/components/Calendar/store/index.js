...
import { useCustomCourseList } from "../CustomCalendar/courseList";
import { getCustomCourseList } from "../CustomCalendar/courseList2";
...
export const fetchEvents = createAsyncThunk(
  ...
  async (calendars) => {
    ...
    const list = await getCustomCourseList();
    console.log("list fetchEvents",list)
    return list
  }
);
