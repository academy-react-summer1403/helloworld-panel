...
import avatarImg from "../../../assets/images/Comment/avatar-blank.png";
            ...
            <Table hover>
              <thead>
                <tr>
                  ...
                  <th className="text-center">عنوان کامنت</th>
                  <th className="text-center">نمایش کامنت</th>
                  ...
                  return (
                    <tbody key={index}>
                      <tr>
                        ...
                        <td
                          className="px-0 border text-center"
                          style={{
                            maxWidth: "160px",
                            whiteSpace: "nowrap",
                            overflow: "hidden",
