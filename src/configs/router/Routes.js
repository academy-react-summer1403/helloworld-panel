...
const CourseEdit = lazy(() => import("../../components/Courses/CourseEdit"));
...
const AllComment = lazy(() => import("../../components/AllComment"));
...
const EditAssistancePage = lazy(() => import("../../pages/EditAssistance/EditAssistance"));
...
const Routes = [
  ...
  {
    path: "/assistancework/edit/:id",
    element: <EditAssistancePage/>
  },
  {
    path: "/Building",
